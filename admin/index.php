...
<head>
    ...
    <meta name="description" content="Admin Page for Convolution 2018"/>
...
<span style="padding:20px;display: block">Convolution Admin Page</span>
...
if($user==''||$pass==""){
    ...
    echo "<div id='links'>";
    $links=array("All Users","All Registrations","All Users and Registrations","Algomaniac","Circuistic","Sparkhack","Decisia","Inquizzitive","Workshop","Sponsors","Analytics","Queries","Convolution Team");
